 ...
 */
$config['db_host'] = '52.17.212.152';
$config['db_name'] = 'csmv';
$config['db_user'] = 'cscart';
$config['db_password'] = 'HkPiYc8TeEBy5ny3';

// xmart_csmv_user 23@@7Q46w(J]
//
...
$config['http_host'] = 'dentacarts.com';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'dentacarts.com';
$config['https_path'] = '';
